...
def test_proof_pile_md_latex_v3_config_loads_expected_values():
    cfg = load_config(ROOT / "configs" / "tokenizer_bpe_proof_pile_md_latex_v3_train.yaml")

    assert cfg["run"]["output_dir"] == "artifacts/tokenizer/runs_proof_pile_md_latex_v3_train"
    ...
    assert cfg["pretokenizer"]["pattern"] == "md_latex_fast_v3"
