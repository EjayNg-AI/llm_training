...
def test_proof_pile_md_latex_config_loads_expected_values():
    cfg = load_config(ROOT / "configs" / "tokenizer_bpe_proof_pile_md_latex_train.yaml")

    assert cfg["run"]["output_dir"] == "artifacts/tokenizer/runs_proof_pile_md_latex_train"
